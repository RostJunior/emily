 ...
 <div id="boxWrapp">
	...
	<nav class="navbar navbar-inverse" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand bg-primary" href="#about">EMILY</a>
        </div>
          ...
          <div class="col-md-10  col-md-offset-1">
		   ...
		   <div class="col-md-12">
                ...
                <c:forEach items="${allType}" var="type">   
                    <li><span>/</span></li>
                    <li><a class="btn btn-link linear" href="#" data-group="${type.nameType}">${type.nameType}</a></li>
				</c:forEach>	
   ...
   <script type="<c:url value="/resources/js/ekko-lightbox.js"/>"></script>
